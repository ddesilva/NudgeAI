...
final class SessionController: ObservableObject {
    ...
    private func ensurePermission() -> Bool {
        ...
        Cue needs Screen Recording access to capture the regions you highlight.

        Open System Settings ▸ Privacy & Security ▸ Screen Recording, enable Cue, \
        then start a session again. You may need to quit and reopen Cue after granting access.
        """
    ...
    private func presentCaptureFailure() {
        ...
        alert.informativeText = "The capture returned no image. Make sure Screen Recording is enabled for Cue and try again."
        alert.runModal()
    }
